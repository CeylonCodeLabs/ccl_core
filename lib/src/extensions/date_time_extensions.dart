...
//region time
  /// Result => 7:05 AM
  String? tohmma() => this == null ? null : DateFormat('h:mm a').format(this!);

  /// Result => 7:05:12 AM
  String? tohmmssa() =>
      this == null ? null : DateFormat('h:mm:ss a').format(this!);

  /// Result => 07:05 AM
  String? tohhmma() =>
      this == null ? null : DateFormat('hh:mm a').format(this!);

  /// Result => 07:05:12 AM
  String? tohhmmssa() =>
      this == null ? null : DateFormat('hh:mm:ss a').format(this!);

  /// Result => 19:05
  String? toHmm() => this == null ? null : DateFormat('H:mm').format(this!);

  /// Result => 19:05
  String? toHHmm() => this == null ? null : DateFormat('HH:mm').format(this!);

  /// Result => 19:05:12
  String? toHHmmss() => this == null ? null : DateFormat('HH:mm').format(this!);
//endregion time
}
